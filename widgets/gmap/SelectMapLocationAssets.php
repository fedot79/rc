...
{
    public $sourcePath = '@app/widgets/gmap/js';
    public $css = [];
    public $js = [
    ...
    public static function register($view)
    {
        ...
        $view->registerJsFile('https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&language=ru&key=' . self::$googleMapApiKey);
